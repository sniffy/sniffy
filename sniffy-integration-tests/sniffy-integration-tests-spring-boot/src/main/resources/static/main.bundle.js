...
var AppComponent = (function () {
    ...
    AppComponent.prototype.makeRestCall = function () {
        console.log('Make REST call');
        this.http.get('/restservice').map(function (response) { return response.json(); }).subscribe(function (data) { return console.log(data); }, function (error) { return console.log('Error ' + error); }, function () { return console.log('Completed!'); });
    };
...
module.exports = "<h1>\n  {{title}}\n  \n</h1>\n<button (click)=\"makeRestCall()\">REST</button>\n"
