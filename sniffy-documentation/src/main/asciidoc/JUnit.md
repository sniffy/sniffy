...
Sniffy comes with a [JUnit](http://junit.org/) @Rule for quick integration with test framework. Just add `@Rule public final QueryCounter queryCounter = new QueryCounter();` to your JUnit test class and place appropriate expectations on your test methods like shown below:
