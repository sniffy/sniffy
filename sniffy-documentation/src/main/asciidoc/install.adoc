...
|Spring Framework 5.3.39 / Spring Boot 2.7.18
|Java 8
|===
...
|`sniffy-web-javax`
|Java 8
|Tomcat 9.0.120 / Javax Servlet 4.0
|The legacy Javax filter loads, intercepts a request, and injects the Sniffy response metadata and widget.

|`sniffy-web`
|Java 8
|Tomcat 10.0.27 / Jakarta Servlet 5.0
|The Servlet 5 artifact runs on its minimum Java baseline and performs the same real filter request contract.

|`sniffy-web`
|Java 17+
|Tomcat 10.1.57 / Jakarta Servlet 6.0
|The Servlet 5-compiled artifact remains runtime-compatible with the current Tomcat 10.1 line.

|`sniffy-web`
|Java 17+
|Tomcat 11.0.24 / Jakarta Servlet 6.1
|The Servlet 5-compiled artifact remains runtime-compatible with the current Servlet 6.1 container line.
|===
