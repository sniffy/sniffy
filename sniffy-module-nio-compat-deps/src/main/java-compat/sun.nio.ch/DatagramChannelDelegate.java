...
public abstract class DatagramChannelDelegate extends DatagramChannel implements SelChImpl {
    ...
    public DatagramChannelDelegate(SelectorProvider provider, Object delegate) {
        super(provider);
