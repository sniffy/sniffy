...
public abstract class PipeSourceChannelDelegate extends Pipe.SourceChannel implements SelChImpl {
    ...
    public PipeSourceChannelDelegate(SelectorProvider provider, Pipe.SourceChannel delegate) {
        super(provider);
