...
public abstract class PipeSinkChannelDelegate extends Pipe.SinkChannel implements SelChImpl {
    ...
    public PipeSinkChannelDelegate(SelectorProvider provider, Pipe.SinkChannel delegate) {
        super(provider);
