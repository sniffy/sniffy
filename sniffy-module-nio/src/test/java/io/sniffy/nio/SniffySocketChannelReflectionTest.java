...
public class SniffySocketChannelReflectionTest {
    ...
    public void testAllMethodsDelegated() {
        ...
        Arrays.stream(SocketChannel.class.getDeclaredMethods())
                ...
                .forEach(m -> {
                    if (getDeclaredMethods(SniffySocketChannel.class).stream().noneMatch(w ->
