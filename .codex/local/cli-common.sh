...
DEFAULT_WORKER_PROFILE="${AI_DELIVERY_CODEX_DEFAULT_PROFILE:-balanced}"
ECONOMY_MODEL="${AI_DELIVERY_CODEX_ECONOMY_MODEL:-gpt-5.6-luna}"
ECONOMY_REASONING="${AI_DELIVERY_CODEX_ECONOMY_REASONING:-low}"
BALANCED_MODEL="${AI_DELIVERY_CODEX_BALANCED_MODEL:-gpt-5.6-terra}"
BALANCED_REASONING="${AI_DELIVERY_CODEX_BALANCED_REASONING:-medium}"
FRONTIER_MODEL="${AI_DELIVERY_CODEX_FRONTIER_MODEL:-gpt-5.6-sol}"
FRONTIER_REASONING="${AI_DELIVERY_CODEX_FRONTIER_REASONING:-high}"
export REPOSITORY BASE_BRANCH STATE_ROOT WORKTREE_ROOT CONTROL_LABEL CONTROL_TIMEOUT_SECONDS
export SPAWN_TIMEOUT_SECONDS PROVISIONAL_LEASE_SECONDS NORMAL_LEASE_SECONDS
export DEFAULT_WORKER_PROFILE ECONOMY_MODEL ECONOMY_REASONING BALANCED_MODEL BALANCED_REASONING
export FRONTIER_MODEL FRONTIER_REASONING
