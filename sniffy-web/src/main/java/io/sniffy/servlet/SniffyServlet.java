...
public class SniffyServlet extends HttpServlet {
    ...
    private final static String SNIFFY_UI_VERSION = "3.2.0"; // TODO: avoid changing it each time
    ...
    private void addCorsHeaders(HttpServletResponse response) {
        ...
        response.addHeader("Access-Control-Allow-Headers", "Sniffy-Enabled,Sniffy-Inject-Html-Enabled,X-Requested-With,Content-Type");
