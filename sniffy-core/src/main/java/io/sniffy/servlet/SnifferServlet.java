...
class SnifferServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        try {
            javascript = loadResource("/META-INF/resources/webjars/sniffy/3.1.0-RC4-SNAPSHOT/dist/sniffy.min.js");
            map = loadResource("/META-INF/resources/webjars/sniffy/3.1.0-RC4-SNAPSHOT/dist/sniffy.map");
        } catch (IOException e) {
