...
class SniffyServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        try {
            javascript = loadResource("/META-INF/resources/webjars/sniffy/3.1.0-RC10/dist/sniffy.min.js");
            map = loadResource("/META-INF/resources/webjars/sniffy/3.1.0-RC10/dist/sniffy.map");
        } catch (IOException e) {
