...
This private workspace package owns design primitives shared by Sniffy applications. It has three explicit entry points:
...
- The profiler and agent intentionally select the dark palette by default. Other palettes are outside this package's current scope.
