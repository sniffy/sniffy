---
sidebar_label: Shared connection
---
...
<!-- archived-snippet:sniffy-test-sniffy-test-common-src-test-java-io-sniffy-test-sharedconnectiondatasourcetest--sharedconnectiondatasourceusage -->
